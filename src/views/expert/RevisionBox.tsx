...
function RevisionBox(props: CaseContent) {
  ...
  const descriptionsItems: DescriptionsProps["items"] = [
    ...
    },
    {
      ...
      label: "修改记录",
      children: (
        <Select defaultValue={"无"} style={{ width: 120 }} options={props.revisionRecords} />
      ),
    },
  ];
    ...
    <>
      {props.userRequestInfo.requestId === "" ? (
        ...
        <div
          ...
          <Descriptions style={{ marginBottom: "1rem" }} items={descriptionsItems}></Descriptions>
          <div style={{ marginBottom: "1rem" }}>点击预览后可以翻页查看作物。</div>
          <Image.PreviewGroup items={[...props.userRequestInfo.imageUrls.split(",")]}>
            <Image width="100%" src={props.userRequestInfo.imageUrls.split(",")[0]} />
          </Image.PreviewGroup>
          <RevisionText
